...
> Forked from [ryoppippi/dotfiles](https://github.com/ryoppippi/dotfiles) and customised for asktt1770's own setup. User/machine-specific values live in the untracked-upstream `personal.nix`, so syncing upstream stays conflict-free.
